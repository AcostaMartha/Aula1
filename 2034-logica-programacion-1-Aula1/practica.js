...
//asígnale el valor "¡Error! Preencha todos los campos." 
...
//8.Utiliza un prompt para preguntar el nombre del 
//usuario y almacénalo en la variable nombre.
let nombrecliente = prompt("Coloca su Nombre: ")
//9.Pide al usuario que ingrese su edad usando un prompt y almacénala en la variable edad.
let Edad = prompt("Coloque su edad:");
//10.Ahora, si la edad es mayor o igual a 18, 
//muestra una alerta con el mensaje "¡Puede obtener su licencia de conducir!".

if (edad <= 18) {
    alert("Puede Optener su licencia de conducir");
} else {
    alert("Lo sentimos aun no puede tener los permisos")
}
